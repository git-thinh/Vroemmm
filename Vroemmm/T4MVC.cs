...
{
    public static Vroemmm.Controllers.AccountController Account = new Vroemmm.Controllers.T4MVC_AccountController();
    ...
    public static Vroemmm.Controllers.CalendarController Calendar = new Vroemmm.Controllers.T4MVC_CalendarController();
    public static Vroemmm.Controllers.GoogleAuthenticationController GoogleAuthentication = new Vroemmm.Controllers.T4MVC_GoogleAuthenticationController();
    public static Vroemmm.Controllers.HomeController Home = new Vroemmm.Controllers.T4MVC_HomeController();
    public static Vroemmm.Controllers.TravelController Travel = new Vroemmm.Controllers.T4MVC_TravelController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string jquery_migrate_1_1_0_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-migrate-1.1.0.min.js") ? Url("jquery-migrate-1.1.0.min.js") : Url("jquery-migrate-1.1.0.js");
                      
        public static readonly string jquery_migrate_1_1_0_min_js = Url("jquery-migrate-1.1.0.min.js");
